...
/**
 * Application Lifecycle Service — Quarkus CDI bean.
 *
 * Migrated from {@code ApplicationServiceEjb} (monolith dlis-core).
 * Implements the following CA Gen action blocks:
 *   AB-CREATE-APPLICATION
 *   AB-CHECK-ELIGIBILITY
 *   AB-CHECK-HISTORY
 *   AB-INQUIRE-APPLICATION-STATUS
 *
 * In the microservices architecture the candidate validation call
 * (previously an in-process EJB @Inject) is made via the REST client
 * {@link CandidateSvcClient} to the candidate-svc.
 */
@ApplicationScoped
public class ApplicationService {
    ...
    void updatePaymentStatus(Long applicationId, String paymentStatus,
    ...
    void updateApproval1(Long applicationId, String decision, String authorityName,
    ...
    void updateApproval2(Long applicationId, String decision, String authorityName,
                         LocalDate decisionDate, String notes, String appStatus,
                         LocalDate lastUpdated, String updatedBy) {
        String sql = "UPDATE DLIS.LICENSE_APPLICATION SET " +
    ...
    void updateApplicationStatus(Long applicationId, String appStatus,
                                  LocalDate lastUpdated, String updatedBy) {
        String sql = "UPDATE DLIS.LICENSE_APPLICATION SET " +
                "APPLICATION_STATUS=?,LAST_UPDATED_DATE=?,LAST_UPDATED_BY=? WHERE APPLICATION_ID=?";
    ...
    /** Lightweight inner class for driving history rows (not a public domain object). */
